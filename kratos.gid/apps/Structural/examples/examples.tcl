...
proc Structural::examples::Init { } {
    ...
    uplevel #0 [list source [file join $::Structural::dir examples Membrane.tcl]]
}
...
proc Structural::examples::UpdateMenus { } {
    ...
    GiDMenu::InsertOption "Kratos" [list "Membrane" ] [incr menu_id] PRE [list ::Structural::examples::Membrane] "" "" insertbefore =
